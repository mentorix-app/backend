...
type InsertProgramDayRow struct {
	ID     pgtype.UUID `json:"id"`
	DayKey pgtype.UUID `json:"day_key"`
}

func (q *Queries) InsertProgramDay(ctx context.Context, arg InsertProgramDayParams) (InsertProgramDayRow, error) {
