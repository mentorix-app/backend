...
- **Программа:** краткая информация → inline выбор недели → inline выбор дня → упражнения на день. В списках только недели/дни с ≥1 упражнением (пустые блоки и дни отдыха не показываются).
...
| Кнопка | Поведение |
| ------ | --------- |
| Программа | краткая информация + inline выбор недели → дня → упражнения |
