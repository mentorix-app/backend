...
- **Программа:** краткая информация → inline выбор недели → inline выбор дня → упражнения на день. В списках только недели/дни с ≥1 упражнением (пустые блоки и дни отдыха не показываются). На экране дня: «Следующий день» (следующий тренировочный день в неделе) или «Следующая неделя» (выбор дня в следующей неделе с тренировками); на последнем дне программы кнопки нет.
...
| Кнопка | Поведение |
| ------ | --------- |
| Программа | краткая информация + inline выбор недели → дня → упражнения; на экране дня — «Следующий день» или «Следующая неделя» для навигации до конца программы |
